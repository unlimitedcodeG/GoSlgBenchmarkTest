...
// 	protoc        (unknown)
// source: v1.1.0/event/activity.proto
...
func (ActivityType) Descriptor() protoreflect.EnumDescriptor {
	return file_v1_1_0_event_activity_proto_enumTypes[0].Descriptor()
}

func (ActivityType) Type() protoreflect.EnumType {
	return &file_v1_1_0_event_activity_proto_enumTypes[0]
}
...
func (ActivityType) EnumDescriptor() ([]byte, []int) {
	return file_v1_1_0_event_activity_proto_rawDescGZIP(), []int{0}
}
...
const (
	...
	ActivityStatus_ACTIVITY_STATUS_UPCOMING  ActivityStatus = 1 // 即将开�?
	ActivityStatus_ACTIVITY_STATUS_ACTIVE    ActivityStatus = 2 // 进行�?
	ActivityStatus_ACTIVITY_STATUS_PAUSED    ActivityStatus = 3 // 暂停
	ActivityStatus_ACTIVITY_STATUS_ENDED     ActivityStatus = 4 // 已结�?
	ActivityStatus_ACTIVITY_STATUS_CANCELLED ActivityStatus = 5 // 已取�?
)
...
func (ActivityStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_v1_1_0_event_activity_proto_enumTypes[1].Descriptor()
}

func (ActivityStatus) Type() protoreflect.EnumType {
	return &file_v1_1_0_event_activity_proto_enumTypes[1]
}
...
func (ActivityStatus) EnumDescriptor() ([]byte, []int) {
	return file_v1_1_0_event_activity_proto_rawDescGZIP(), []int{1}
}
...
func (ActivityStageType) Descriptor() protoreflect.EnumDescriptor {
	return file_v1_1_0_event_activity_proto_enumTypes[2].Descriptor()
}

func (ActivityStageType) Type() protoreflect.EnumType {
	return &file_v1_1_0_event_activity_proto_enumTypes[2]
}
...
func (ActivityStageType) EnumDescriptor() ([]byte, []int) {
	return file_v1_1_0_event_activity_proto_rawDescGZIP(), []int{2}
}
...
const (
	...
	ActivityTaskType_ACTIVITY_TASK_TYPE_SPEND_RESOURCE ActivityTaskType = 4 // 消耗资�?
...
func (ActivityTaskType) Descriptor() protoreflect.EnumDescriptor {
	return file_v1_1_0_event_activity_proto_enumTypes[3].Descriptor()
}

func (ActivityTaskType) Type() protoreflect.EnumType {
	return &file_v1_1_0_event_activity_proto_enumTypes[3]
}
...
func (ActivityTaskType) EnumDescriptor() ([]byte, []int) {
	return file_v1_1_0_event_activity_proto_rawDescGZIP(), []int{3}
}
...
const (
	...
	ActivityRewardType_ACTIVITY_REWARD_TYPE_MILESTONE     ActivityRewardType = 1 // 里程碑奖�?
...
func (ActivityRewardType) Descriptor() protoreflect.EnumDescriptor {
	return file_v1_1_0_event_activity_proto_enumTypes[4].Descriptor()
}

func (ActivityRewardType) Type() protoreflect.EnumType {
	return &file_v1_1_0_event_activity_proto_enumTypes[4]
}
...
func (ActivityRewardType) EnumDescriptor() ([]byte, []int) {
	return file_v1_1_0_event_activity_proto_rawDescGZIP(), []int{4}
}
...
func (ActivityRankType) Descriptor() protoreflect.EnumDescriptor {
	return file_v1_1_0_event_activity_proto_enumTypes[5].Descriptor()
}

func (ActivityRankType) Type() protoreflect.EnumType {
	return &file_v1_1_0_event_activity_proto_enumTypes[5]
}
...
func (ActivityRankType) EnumDescriptor() ([]byte, []int) {
	return file_v1_1_0_event_activity_proto_rawDescGZIP(), []int{5}
}
...
const (
	...
	ActivityResult_ACTIVITY_RESULT_NOT_ELIGIBLE      ActivityResult = 3 // 不符合条�?
	ActivityResult_ACTIVITY_RESULT_ALREADY_COMPLETED ActivityResult = 4 // 已完�?
	ActivityResult_ACTIVITY_RESULT_NOT_STARTED       ActivityResult = 5 // 未开�?
	ActivityResult_ACTIVITY_RESULT_ENDED             ActivityResult = 6 // 已结�?
)
...
func (ActivityResult) Descriptor() protoreflect.EnumDescriptor {
	return file_v1_1_0_event_activity_proto_enumTypes[6].Descriptor()
}

func (ActivityResult) Type() protoreflect.EnumType {
	return &file_v1_1_0_event_activity_proto_enumTypes[6]
}
...
func (ActivityResult) EnumDescriptor() ([]byte, []int) {
	return file_v1_1_0_event_activity_proto_rawDescGZIP(), []int{6}
}
...
type ActivityInfoRequest struct {
	...
	ActivityIds   []string               `protobuf:"bytes,2,rep,name=activity_ids,json=activityIds,proto3" json:"activity_ids,omitempty"`     // 指定活动ID列表(空表示所�?
	IncludeEnded  bool                   `protobuf:"varint,3,opt,name=include_ended,json=includeEnded,proto3" json:"include_ended,omitempty"` // 是否包含已结束活�?
...
func (x *ActivityInfoRequest) Reset() {
	*x = ActivityInfoRequest{}
	mi := &file_v1_1_0_event_activity_proto_msgTypes[0]
...
type ActivityInfoResponse struct {
	...
	ServerTime    int64                  `protobuf:"varint,2,opt,name=server_time,json=serverTime,proto3" json:"server_time,omitempty"` // 服务器时�?
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ActivityInfoResponse) Reset() {
	*x = ActivityInfoResponse{}
	mi := &file_v1_1_0_event_activity_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *ParticipateActivityRequest) Reset() {
	*x = ParticipateActivityRequest{}
	mi := &file_v1_1_0_event_activity_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type ParticipateActivityResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Result        ActivityResult         `protobuf:"varint,1,opt,name=result,proto3,enum=slg.event.v1_1_0.ActivityResult" json:"result,omitempty"` // 参与结果
...
func (x *ParticipateActivityResponse) Reset() {
	*x = ParticipateActivityResponse{}
	mi := &file_v1_1_0_event_activity_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type ActivityLeaderboardRequest struct {
	...
	RankType      ActivityRankType       `protobuf:"varint,3,opt,name=rank_type,json=rankType,proto3,enum=slg.event.v1_1_0.ActivityRankType" json:"rank_type,omitempty"` // 排行类型
...
func (x *ActivityLeaderboardRequest) Reset() {
	*x = ActivityLeaderboardRequest{}
	mi := &file_v1_1_0_event_activity_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type ActivityLeaderboardResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Entries       []*ActivityRankEntry   `protobuf:"bytes,1,rep,name=entries,proto3" json:"entries,omitempty"`                          // 排行榜条�?
	...
	TotalCount    int32                  `protobuf:"varint,3,opt,name=total_count,json=totalCount,proto3" json:"total_count,omitempty"` // 总参与人�?
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ActivityLeaderboardResponse) Reset() {
	*x = ActivityLeaderboardResponse{}
	mi := &file_v1_1_0_event_activity_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *ClaimActivityRewardRequest) Reset() {
	*x = ClaimActivityRewardRequest{}
	mi := &file_v1_1_0_event_activity_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type ClaimActivityRewardResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Rewards       []*ActivityReward      `protobuf:"bytes,1,rep,name=rewards,proto3" json:"rewards,omitempty"`   // 领取的奖�?
...
func (x *ClaimActivityRewardResponse) Reset() {
	*x = ClaimActivityRewardResponse{}
	mi := &file_v1_1_0_event_activity_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ClaimActivityRewardResponse) Descriptor() ([]byte, []int) {
	return file_v1_1_0_event_activity_proto_rawDescGZIP(), []int{7}
}
...
type Activity struct {
	...
	ActivityType  ActivityType           `protobuf:"varint,4,opt,name=activity_type,json=activityType,proto3,enum=slg.event.v1_1_0.ActivityType" json:"activity_type,omitempty"`        // 活动类型
	Status        ActivityStatus         `protobuf:"varint,5,opt,name=status,proto3,enum=slg.event.v1_1_0.ActivityStatus" json:"status,omitempty"`                                      // 活动状�?
	StartTime     int64                  `protobuf:"varint,6,opt,name=start_time,json=startTime,proto3" json:"start_time,omitempty"`                                                    // 开始时�?
...
func (x *Activity) Reset() {
	*x = Activity{}
	mi := &file_v1_1_0_event_activity_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Activity) Descriptor() ([]byte, []int) {
	return file_v1_1_0_event_activity_proto_rawDescGZIP(), []int{8}
}
...
type ActivityStage struct {
	...
	StageType     ActivityStageType      `protobuf:"varint,7,opt,name=stage_type,json=stageType,proto3,enum=slg.event.v1_1_0.ActivityStageType" json:"stage_type,omitempty"`                        // 阶段类型
...
func (x *ActivityStage) Reset() {
	*x = ActivityStage{}
	mi := &file_v1_1_0_event_activity_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ActivityStage) Descriptor() ([]byte, []int) {
	return file_v1_1_0_event_activity_proto_rawDescGZIP(), []int{9}
}
...
type ActivityTask struct {
	...
	TaskType      ActivityTaskType       `protobuf:"varint,4,opt,name=task_type,json=taskType,proto3,enum=slg.event.v1_1_0.ActivityTaskType" json:"task_type,omitempty"`                  // 任务类型
	...
	IsRepeatable  bool                   `protobuf:"varint,7,opt,name=is_repeatable,json=isRepeatable,proto3" json:"is_repeatable,omitempty"`                                             // 是否可重�?
	MaxCount      int32                  `protobuf:"varint,8,opt,name=max_count,json=maxCount,proto3" json:"max_count,omitempty"`                                                         // 最大完成次�?
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ActivityTask) Reset() {
	*x = ActivityTask{}
	mi := &file_v1_1_0_event_activity_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ActivityTask) Descriptor() ([]byte, []int) {
	return file_v1_1_0_event_activity_proto_rawDescGZIP(), []int{10}
}
...
type ActivityProgress struct {
	...
	CompletedTasks []string               `protobuf:"bytes,6,rep,name=completed_tasks,json=completedTasks,proto3" json:"completed_tasks,omitempty"`                                                                         // 已完成任�?
	ClaimedRewards []string               `protobuf:"bytes,7,rep,name=claimed_rewards,json=claimedRewards,proto3" json:"claimed_rewards,omitempty"`                                                                         // 已领取奖�?
	TotalScore     int32                  `protobuf:"varint,8,opt,name=total_score,json=totalScore,proto3" json:"total_score,omitempty"`                                                                                    // 总积�?
	LastUpdateTime int64                  `protobuf:"varint,9,opt,name=last_update_time,json=lastUpdateTime,proto3" json:"last_update_time,omitempty"`                                                                      // 最后更新时�?
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *ActivityProgress) Reset() {
	*x = ActivityProgress{}
	mi := &file_v1_1_0_event_activity_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ActivityProgress) Descriptor() ([]byte, []int) {
	return file_v1_1_0_event_activity_proto_rawDescGZIP(), []int{11}
}
...
type ActivityReward struct {
	...
	RewardType    ActivityRewardType     `protobuf:"varint,3,opt,name=reward_type,json=rewardType,proto3,enum=slg.event.v1_1_0.ActivityRewardType" json:"reward_type,omitempty"`              // 奖励类型
	...
	IsClaimed     bool                   `protobuf:"varint,9,opt,name=is_claimed,json=isClaimed,proto3" json:"is_claimed,omitempty"`                                                          // 是否已领�?
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ActivityReward) Reset() {
	*x = ActivityReward{}
	mi := &file_v1_1_0_event_activity_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ActivityReward) Descriptor() ([]byte, []int) {
	return file_v1_1_0_event_activity_proto_rawDescGZIP(), []int{12}
}
...
type ActivityCondition struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	MinLevel        int32                  `protobuf:"varint,1,opt,name=min_level,json=minLevel,proto3" json:"min_level,omitempty"`                     // 最低等�?
	...
	RequiredItems   []string               `protobuf:"bytes,3,rep,name=required_items,json=requiredItems,proto3" json:"required_items,omitempty"`       // 需要物�?
...
func (x *ActivityCondition) Reset() {
	*x = ActivityCondition{}
	mi := &file_v1_1_0_event_activity_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ActivityCondition) Descriptor() ([]byte, []int) {
	return file_v1_1_0_event_activity_proto_rawDescGZIP(), []int{13}
}
...
func (x *ActivityRankEntry) Reset() {
	*x = ActivityRankEntry{}
	mi := &file_v1_1_0_event_activity_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ActivityRankEntry) Descriptor() ([]byte, []int) {
	return file_v1_1_0_event_activity_proto_rawDescGZIP(), []int{14}
}
...
type ActivityPlayerRank struct {
	...
	Percentage          int32                  `protobuf:"varint,3,opt,name=percentage,proto3" json:"percentage,omitempty"`                                                  // 排名百分�?
	IsEligibleForReward bool                   `protobuf:"varint,4,opt,name=is_eligible_for_reward,json=isEligibleForReward,proto3" json:"is_eligible_for_reward,omitempty"` // 是否有奖励资�?
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *ActivityPlayerRank) Reset() {
	*x = ActivityPlayerRank{}
	mi := &file_v1_1_0_event_activity_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ActivityPlayerRank) Descriptor() ([]byte, []int) {
	return file_v1_1_0_event_activity_proto_rawDescGZIP(), []int{15}
}
...
var File_v1_1_0_event_activity_proto protoreflect.FileDescriptor

const file_v1_1_0_event_activity_proto_rawDesc = "" +
	"\n" +
	"\x1bv1.1.0/event/activity.proto\x12\x10slg.event.v1_1_0\x1a\x19v1.1.0/common/types.proto\"z\n" +
	"\x13ActivityInfoRequest\x12\x1b\n" +
	"\tplayer_id\x18\x01 \x01(\tR\bplayerId\x12!\n" +
	"\factivity_ids\x18\x02 \x03(\tR\vactivityIds\x12#\n" +
	"\rinclude_ended\x18\x03 \x01(\bR\fincludeEnded\"s\n" +
	"\x14ActivityInfoResponse\x12:\n" +
	"\n" +
	"activities\x18\x01 \x03(\v2\x1a.slg.event.v1_1_0.ActivityR\n" +
	"activities\x12\x1f\n" +
	...
	"activityId\x12\x19\n" +
	"\bstage_id\x18\x03 \x01(\tR\astageId\x12P\n" +
	"\x06params\x18\x04 \x03(\v28.slg.event.v1_1_0.ParticipateActivityRequest.ParamsEntryR\x06params\x1a9\n" +
	"\vParamsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\xf5\x01\n" +
	"\x1bParticipateActivityResponse\x128\n" +
	"\x06result\x18\x01 \x01(\x0e2 .slg.event.v1_1_0.ActivityResultR\x06result\x128\n" +
	"\x06reward\x18\x02 \x01(\v2 .slg.event.v1_1_0.ActivityRewardR\x06reward\x12>\n" +
	"\bprogress\x18\x03 \x01(\v2\".slg.event.v1_1_0.ActivityProgressR\bprogress\x12\"\n" +
	"\rnext_stage_id\x18\x04 \x01(\tR\vnextStageId\"\xca\x01\n" +
	"\x1aActivityLeaderboardRequest\x12\x1f\n" +
	"\vactivity_id\x18\x01 \x01(\tR\n" +
	"activityId\x12\x19\n" +
	"\bstage_id\x18\x02 \x01(\tR\astageId\x12?\n" +
	"\trank_type\x18\x03 \x01(\x0e2\".slg.event.v1_1_0.ActivityRankTypeR\brankType\x12\x12\n" +
	"\x04page\x18\x04 \x01(\x05R\x04page\x12\x1b\n" +
	"\tpage_size\x18\x05 \x01(\x05R\bpageSize\"\xc4\x01\n" +
	"\x1bActivityLeaderboardResponse\x12=\n" +
	"\aentries\x18\x01 \x03(\v2#.slg.event.v1_1_0.ActivityRankEntryR\aentries\x12E\n" +
	"\vplayer_rank\x18\x02 \x01(\v2$.slg.event.v1_1_0.ActivityPlayerRankR\n" +
	"playerRank\x12\x1f\n" +
	...
	"activityId\x12\x1d\n" +
	"\n" +
	"reward_ids\x18\x03 \x03(\tR\trewardIds\"\x99\x01\n" +
	"\x1bClaimActivityRewardResponse\x12:\n" +
	"\arewards\x18\x01 \x03(\v2 .slg.event.v1_1_0.ActivityRewardR\arewards\x12>\n" +
	"\bprogress\x18\x02 \x01(\v2\".slg.event.v1_1_0.ActivityProgressR\bprogress\"\xfd\x04\n" +
	"\bActivity\x12\x1f\n" +
	"\vactivity_id\x18\x01 \x01(\tR\n" +
	"activityId\x12#\n" +
	"\ractivity_name\x18\x02 \x01(\tR\factivityName\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12C\n" +
	"\ractivity_type\x18\x04 \x01(\x0e2\x1e.slg.event.v1_1_0.ActivityTypeR\factivityType\x128\n" +
	"\x06status\x18\x05 \x01(\x0e2 .slg.event.v1_1_0.ActivityStatusR\x06status\x12\x1d\n" +
	"\n" +
	"start_time\x18\x06 \x01(\x03R\tstartTime\x12\x19\n" +
	"\bend_time\x18\a \x01(\x03R\aendTime\x127\n" +
	"\x06stages\x18\b \x03(\v2\x1f.slg.event.v1_1_0.ActivityStageR\x06stages\x12:\n" +
	"\arewards\x18\t \x03(\v2 .slg.event.v1_1_0.ActivityRewardR\arewards\x12A\n" +
	"\tcondition\x18\n" +
	" \x01(\v2#.slg.event.v1_1_0.ActivityConditionR\tcondition\x12>\n" +
	"\x06config\x18\v \x03(\v2&.slg.event.v1_1_0.Activity.ConfigEntryR\x06config\x12\x1d\n" +
	"\n" +
	...
	"\bend_time\x18\x05 \x01(\x03R\aendTime\x124\n" +
	"\x05tasks\x18\x06 \x03(\v2\x1e.slg.event.v1_1_0.ActivityTaskR\x05tasks\x12B\n" +
	"\n" +
	"stage_type\x18\a \x01(\x0e2#.slg.event.v1_1_0.ActivityStageTypeR\tstageType\x12U\n" +
	"\frequirements\x18\b \x03(\v21.slg.event.v1_1_0.ActivityStage.RequirementsEntryR\frequirements\x1a?\n" +
	"\x11RequirementsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x05R\x05value:\x028\x01\"\xa6\x03\n" +
	"\fActivityTask\x12\x17\n" +
	"\atask_id\x18\x01 \x01(\tR\x06taskId\x12\x1b\n" +
	"\ttask_name\x18\x02 \x01(\tR\btaskName\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12?\n" +
	"\ttask_type\x18\x04 \x01(\x0e2\".slg.event.v1_1_0.ActivityTaskTypeR\btaskType\x12E\n" +
	"\atargets\x18\x05 \x03(\v2+.slg.event.v1_1_0.ActivityTask.TargetsEntryR\atargets\x128\n" +
	"\x06reward\x18\x06 \x01(\v2 .slg.event.v1_1_0.ActivityRewardR\x06reward\x12#\n" +
	"\ris_repeatable\x18\a \x01(\bR\fisRepeatable\x12\x1b\n" +
	"\tmax_count\x18\b \x01(\x05R\bmaxCount\x1a:\n" +
	"\fTargetsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x05R\x05value:\x028\x01\"\xd3\x04\n" +
	"\x10ActivityProgress\x12\x1f\n" +
	"\vactivity_id\x18\x01 \x01(\tR\n" +
	"activityId\x12\x1b\n" +
	"\tplayer_id\x18\x02 \x01(\tR\bplayerId\x12(\n" +
	"\x10current_stage_id\x18\x03 \x01(\tR\x0ecurrentStageId\x12Y\n" +
	"\rtask_progress\x18\x04 \x03(\v24.slg.event.v1_1_0.ActivityProgress.TaskProgressEntryR\ftaskProgress\x12\\\n" +
	"\x0estage_progress\x18\x05 \x03(\v25.slg.event.v1_1_0.ActivityProgress.StageProgressEntryR\rstageProgress\x12'\n" +
	...
	"rewardName\x12E\n" +
	"\vreward_type\x18\x03 \x01(\x0e2$.slg.event.v1_1_0.ActivityRewardTypeR\n" +
	"rewardType\x12-\n" +
	"\x05items\x18\x04 \x03(\v2\x17.slg.common.v1_1_0.ItemR\x05items\x12\x1e\n" +
	"\n" +
	"experience\x18\x05 \x01(\x05R\n" +
	"experience\x12\x12\n" +
	"\x04gold\x18\x06 \x01(\x05R\x04gold\x12\x19\n" +
	"\btitle_id\x18\a \x01(\tR\atitleId\x12M\n" +
	"\tresources\x18\b \x03(\v2/.slg.event.v1_1_0.ActivityReward.ResourcesEntryR\tresources\x12\x1d\n" +
	"\n" +
	...
	"\x10forbidden_stages\x18\x05 \x03(\tR\x0fforbiddenStages\"\xb7\x02\n" +
	...
	"playerName\x12\x14\n" +
	"\x05score\x18\x04 \x01(\x05R\x05score\x12D\n" +
	"\x05stats\x18\x05 \x03(\v2..slg.event.v1_1_0.ActivityRankEntry.StatsEntryR\x05stats\x12\x1d\n" +
	"\n" +
...
var (
	...
	file_v1_1_0_event_activity_proto_rawDescData []byte
)

func file_v1_1_0_event_activity_proto_rawDescGZIP() []byte {
	file_v1_1_0_event_activity_proto_rawDescOnce.Do(func() {
		file_v1_1_0_event_activity_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_v1_1_0_event_activity_proto_rawDesc), len(file_v1_1_0_event_activity_proto_rawDesc)))
	})
	return file_v1_1_0_event_activity_proto_rawDescData
}

var file_v1_1_0_event_activity_proto_enumTypes = make([]protoimpl.EnumInfo, 7)
var file_v1_1_0_event_activity_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
var file_v1_1_0_event_activity_proto_goTypes = []any{
	(ActivityType)(0),                   // 0: slg.event.v1_1_0.ActivityType
	(ActivityStatus)(0),                 // 1: slg.event.v1_1_0.ActivityStatus
	(ActivityStageType)(0),              // 2: slg.event.v1_1_0.ActivityStageType
	(ActivityTaskType)(0),               // 3: slg.event.v1_1_0.ActivityTaskType
	(ActivityRewardType)(0),             // 4: slg.event.v1_1_0.ActivityRewardType
	(ActivityRankType)(0),               // 5: slg.event.v1_1_0.ActivityRankType
	(ActivityResult)(0),                 // 6: slg.event.v1_1_0.ActivityResult
	(*ActivityInfoRequest)(nil),         // 7: slg.event.v1_1_0.ActivityInfoRequest
	(*ActivityInfoResponse)(nil),        // 8: slg.event.v1_1_0.ActivityInfoResponse
	(*ParticipateActivityRequest)(nil),  // 9: slg.event.v1_1_0.ParticipateActivityRequest
	(*ParticipateActivityResponse)(nil), // 10: slg.event.v1_1_0.ParticipateActivityResponse
	(*ActivityLeaderboardRequest)(nil),  // 11: slg.event.v1_1_0.ActivityLeaderboardRequest
	(*ActivityLeaderboardResponse)(nil), // 12: slg.event.v1_1_0.ActivityLeaderboardResponse
	(*ClaimActivityRewardRequest)(nil),  // 13: slg.event.v1_1_0.ClaimActivityRewardRequest
	(*ClaimActivityRewardResponse)(nil), // 14: slg.event.v1_1_0.ClaimActivityRewardResponse
	(*Activity)(nil),                    // 15: slg.event.v1_1_0.Activity
	(*ActivityStage)(nil),               // 16: slg.event.v1_1_0.ActivityStage
	(*ActivityTask)(nil),                // 17: slg.event.v1_1_0.ActivityTask
	(*ActivityProgress)(nil),            // 18: slg.event.v1_1_0.ActivityProgress
	(*ActivityReward)(nil),              // 19: slg.event.v1_1_0.ActivityReward
	(*ActivityCondition)(nil),           // 20: slg.event.v1_1_0.ActivityCondition
	(*ActivityRankEntry)(nil),           // 21: slg.event.v1_1_0.ActivityRankEntry
	(*ActivityPlayerRank)(nil),          // 22: slg.event.v1_1_0.ActivityPlayerRank
	nil,                                 // 23: slg.event.v1_1_0.ParticipateActivityRequest.ParamsEntry
	nil,                                 // 24: slg.event.v1_1_0.Activity.ConfigEntry
	nil,                                 // 25: slg.event.v1_1_0.ActivityStage.RequirementsEntry
	nil,                                 // 26: slg.event.v1_1_0.ActivityTask.TargetsEntry
	nil,                                 // 27: slg.event.v1_1_0.ActivityProgress.TaskProgressEntry
	nil,                                 // 28: slg.event.v1_1_0.ActivityProgress.StageProgressEntry
	nil,                                 // 29: slg.event.v1_1_0.ActivityReward.ResourcesEntry
	nil,                                 // 30: slg.event.v1_1_0.ActivityRankEntry.StatsEntry
	(*common.Item)(nil),                 // 31: slg.common.v1_1_0.Item
}
var file_v1_1_0_event_activity_proto_depIdxs = []int32{
	15, // 0: slg.event.v1_1_0.ActivityInfoResponse.activities:type_name -> slg.event.v1_1_0.Activity
	23, // 1: slg.event.v1_1_0.ParticipateActivityRequest.params:type_name -> slg.event.v1_1_0.ParticipateActivityRequest.ParamsEntry
	6,  // 2: slg.event.v1_1_0.ParticipateActivityResponse.result:type_name -> slg.event.v1_1_0.ActivityResult
	19, // 3: slg.event.v1_1_0.ParticipateActivityResponse.reward:type_name -> slg.event.v1_1_0.ActivityReward
	18, // 4: slg.event.v1_1_0.ParticipateActivityResponse.progress:type_name -> slg.event.v1_1_0.ActivityProgress
	5,  // 5: slg.event.v1_1_0.ActivityLeaderboardRequest.rank_type:type_name -> slg.event.v1_1_0.ActivityRankType
	21, // 6: slg.event.v1_1_0.ActivityLeaderboardResponse.entries:type_name -> slg.event.v1_1_0.ActivityRankEntry
	22, // 7: slg.event.v1_1_0.ActivityLeaderboardResponse.player_rank:type_name -> slg.event.v1_1_0.ActivityPlayerRank
	19, // 8: slg.event.v1_1_0.ClaimActivityRewardResponse.rewards:type_name -> slg.event.v1_1_0.ActivityReward
	18, // 9: slg.event.v1_1_0.ClaimActivityRewardResponse.progress:type_name -> slg.event.v1_1_0.ActivityProgress
	0,  // 10: slg.event.v1_1_0.Activity.activity_type:type_name -> slg.event.v1_1_0.ActivityType
	1,  // 11: slg.event.v1_1_0.Activity.status:type_name -> slg.event.v1_1_0.ActivityStatus
	16, // 12: slg.event.v1_1_0.Activity.stages:type_name -> slg.event.v1_1_0.ActivityStage
	19, // 13: slg.event.v1_1_0.Activity.rewards:type_name -> slg.event.v1_1_0.ActivityReward
	20, // 14: slg.event.v1_1_0.Activity.condition:type_name -> slg.event.v1_1_0.ActivityCondition
	24, // 15: slg.event.v1_1_0.Activity.config:type_name -> slg.event.v1_1_0.Activity.ConfigEntry
	17, // 16: slg.event.v1_1_0.ActivityStage.tasks:type_name -> slg.event.v1_1_0.ActivityTask
	2,  // 17: slg.event.v1_1_0.ActivityStage.stage_type:type_name -> slg.event.v1_1_0.ActivityStageType
	25, // 18: slg.event.v1_1_0.ActivityStage.requirements:type_name -> slg.event.v1_1_0.ActivityStage.RequirementsEntry
	3,  // 19: slg.event.v1_1_0.ActivityTask.task_type:type_name -> slg.event.v1_1_0.ActivityTaskType
	26, // 20: slg.event.v1_1_0.ActivityTask.targets:type_name -> slg.event.v1_1_0.ActivityTask.TargetsEntry
	19, // 21: slg.event.v1_1_0.ActivityTask.reward:type_name -> slg.event.v1_1_0.ActivityReward
	27, // 22: slg.event.v1_1_0.ActivityProgress.task_progress:type_name -> slg.event.v1_1_0.ActivityProgress.TaskProgressEntry
	28, // 23: slg.event.v1_1_0.ActivityProgress.stage_progress:type_name -> slg.event.v1_1_0.ActivityProgress.StageProgressEntry
	4,  // 24: slg.event.v1_1_0.ActivityReward.reward_type:type_name -> slg.event.v1_1_0.ActivityRewardType
	31, // 25: slg.event.v1_1_0.ActivityReward.items:type_name -> slg.common.v1_1_0.Item
	29, // 26: slg.event.v1_1_0.ActivityReward.resources:type_name -> slg.event.v1_1_0.ActivityReward.ResourcesEntry
	30, // 27: slg.event.v1_1_0.ActivityRankEntry.stats:type_name -> slg.event.v1_1_0.ActivityRankEntry.StatsEntry
...
func init() { file_v1_1_0_event_activity_proto_init() }
func file_v1_1_0_event_activity_proto_init() {
	if File_v1_1_0_event_activity_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_v1_1_0_event_activity_proto_rawDesc), len(file_v1_1_0_event_activity_proto_rawDesc)),
			NumEnums:      7,
			NumMessages:   24,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_v1_1_0_event_activity_proto_goTypes,
		DependencyIndexes: file_v1_1_0_event_activity_proto_depIdxs,
		EnumInfos:         file_v1_1_0_event_activity_proto_enumTypes,
		MessageInfos:      file_v1_1_0_event_activity_proto_msgTypes,
	}.Build()
	File_v1_1_0_event_activity_proto = out.File
	file_v1_1_0_event_activity_proto_goTypes = nil
	file_v1_1_0_event_activity_proto_depIdxs = nil
}
