...
// 	protoc        v5.29.3
// source: slg-proto/v1.1.0/combat/battle.proto
...
const (
	...
	BattleType_BATTLE_TYPE_GUILD_WAR BattleType = 3 // 公会战
	BattleType_BATTLE_TYPE_ARENA     BattleType = 4 // 竞技场
	BattleType_BATTLE_TYPE_RAID      BattleType = 5 // 团队副本
	// v1.1.0 新增
	BattleType_BATTLE_TYPE_TOURNAMENT BattleType = 6 // 锦标赛
	BattleType_BATTLE_TYPE_SIEGE      BattleType = 7 // 攻城战
)
...
func (BattleType) Descriptor() protoreflect.EnumDescriptor {
	return file_slg_proto_v1_1_0_combat_battle_proto_enumTypes[0].Descriptor()
}

func (BattleType) Type() protoreflect.EnumType {
	return &file_slg_proto_v1_1_0_combat_battle_proto_enumTypes[0]
}
...
func (BattleType) EnumDescriptor() ([]byte, []int) {
	return file_slg_proto_v1_1_0_combat_battle_proto_rawDescGZIP(), []int{0}
}
...
func (BattleResult) Descriptor() protoreflect.EnumDescriptor {
	return file_slg_proto_v1_1_0_combat_battle_proto_enumTypes[1].Descriptor()
}

func (BattleResult) Type() protoreflect.EnumType {
	return &file_slg_proto_v1_1_0_combat_battle_proto_enumTypes[1]
}
...
func (BattleResult) EnumDescriptor() ([]byte, []int) {
	return file_slg_proto_v1_1_0_combat_battle_proto_rawDescGZIP(), []int{1}
}
...
func (BattlePhase) Descriptor() protoreflect.EnumDescriptor {
	return file_slg_proto_v1_1_0_combat_battle_proto_enumTypes[2].Descriptor()
}

func (BattlePhase) Type() protoreflect.EnumType {
	return &file_slg_proto_v1_1_0_combat_battle_proto_enumTypes[2]
}
...
func (BattlePhase) EnumDescriptor() ([]byte, []int) {
	return file_slg_proto_v1_1_0_combat_battle_proto_rawDescGZIP(), []int{2}
}
...
const (
	...
	UnitStatus_UNIT_STATUS_MOVING    UnitStatus = 2 // 移动中
	UnitStatus_UNIT_STATUS_ATTACKING UnitStatus = 3 // 攻击中
	UnitStatus_UNIT_STATUS_CASTING   UnitStatus = 4 // 施法中
	UnitStatus_UNIT_STATUS_STUNNED   UnitStatus = 5 // 晕眩
	UnitStatus_UNIT_STATUS_DEAD      UnitStatus = 6 // 死亡
	// v1.1.0 新增
	UnitStatus_UNIT_STATUS_CHANNELING UnitStatus = 7 // 引导中
...
func (UnitStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_slg_proto_v1_1_0_combat_battle_proto_enumTypes[3].Descriptor()
}

func (UnitStatus) Type() protoreflect.EnumType {
	return &file_slg_proto_v1_1_0_combat_battle_proto_enumTypes[3]
}
...
func (UnitStatus) EnumDescriptor() ([]byte, []int) {
	return file_slg_proto_v1_1_0_combat_battle_proto_rawDescGZIP(), []int{3}
}
...
const (
	...
	ActionType_ACTION_TYPE_ATTACK  ActionType = 2 // 普通攻击
	ActionType_ACTION_TYPE_SKILL   ActionType = 3 // 技能攻击
	...
	ActionType_ACTION_TYPE_ULTIMATE ActionType = 8 // 终极技能
)
...
func (ActionType) Descriptor() protoreflect.EnumDescriptor {
	return file_slg_proto_v1_1_0_combat_battle_proto_enumTypes[4].Descriptor()
}

func (ActionType) Type() protoreflect.EnumType {
	return &file_slg_proto_v1_1_0_combat_battle_proto_enumTypes[4]
}
...
func (ActionType) EnumDescriptor() ([]byte, []int) {
	return file_slg_proto_v1_1_0_combat_battle_proto_rawDescGZIP(), []int{4}
}
...
const (
	...
	BuffType_BUFF_TYPE_ATTACK_UP    BuffType = 1 // 攻击力提升
	BuffType_BUFF_TYPE_DEFENSE_UP   BuffType = 2 // 防御力提升
	BuffType_BUFF_TYPE_SPEED_UP     BuffType = 3 // 速度提升
	BuffType_BUFF_TYPE_ATTACK_DOWN  BuffType = 4 // 攻击力降低
	BuffType_BUFF_TYPE_DEFENSE_DOWN BuffType = 5 // 防御力降低
...
func (BuffType) Descriptor() protoreflect.EnumDescriptor {
	return file_slg_proto_v1_1_0_combat_battle_proto_enumTypes[5].Descriptor()
}

func (BuffType) Type() protoreflect.EnumType {
	return &file_slg_proto_v1_1_0_combat_battle_proto_enumTypes[5]
}
...
func (BuffType) EnumDescriptor() ([]byte, []int) {
	return file_slg_proto_v1_1_0_combat_battle_proto_rawDescGZIP(), []int{5}
}
...
const (
	...
	EnvironmentType_ENVIRONMENT_TYPE_MAGIC_FIELD    EnvironmentType = 4 // 魔法场
)
...
func (EnvironmentType) Descriptor() protoreflect.EnumDescriptor {
	return file_slg_proto_v1_1_0_combat_battle_proto_enumTypes[6].Descriptor()
}

func (EnvironmentType) Type() protoreflect.EnumType {
	return &file_slg_proto_v1_1_0_combat_battle_proto_enumTypes[6]
}
...
func (EnvironmentType) EnumDescriptor() ([]byte, []int) {
	return file_slg_proto_v1_1_0_combat_battle_proto_rawDescGZIP(), []int{6}
}
...
type BattleRequest struct {
	...
	PresetSkills   []string         `protobuf:"bytes,9,rep,name=preset_skills,json=presetSkills,proto3" json:"preset_skills,omitempty"`                                                                                  // 预设技能列表
...
func (x *BattleRequest) Reset() {
	*x = BattleRequest{}
	mi := &file_slg_proto_v1_1_0_combat_battle_proto_msgTypes[0]
...
func (x *BattleResponse) Reset() {
	*x = BattleResponse{}
	mi := &file_slg_proto_v1_1_0_combat_battle_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type BattleStatePush struct {
	...
	ActiveSkills  []string           `protobuf:"bytes,7,rep,name=active_skills,json=activeSkills,proto3" json:"active_skills,omitempty"` // 激活技能列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *BattleStatePush) Reset() {
	*x = BattleStatePush{}
	mi := &file_slg_proto_v1_1_0_combat_battle_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type BattleUnit struct {
	...
	// v1.1.0 新增字段
	AvailableSkills []string       `protobuf:"bytes,11,rep,name=available_skills,json=availableSkills,proto3" json:"available_skills,omitempty"` // 可用技能列表
	Energy          int32          `protobuf:"varint,12,opt,name=energy,proto3" json:"energy,omitempty"`                                         // 能量值
	MaxEnergy       int32          `protobuf:"varint,13,opt,name=max_energy,json=maxEnergy,proto3" json:"max_energy,omitempty"`                  // 最大能量值
...
func (x *BattleUnit) Reset() {
	*x = BattleUnit{}
	mi := &file_slg_proto_v1_1_0_combat_battle_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type BattleAction struct {
	...
	ComboSkills      []string `protobuf:"bytes,12,rep,name=combo_skills,json=comboSkills,proto3" json:"combo_skills,omitempty"`                  // 连击技能
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *BattleAction) Reset() {
	*x = BattleAction{}
	mi := &file_slg_proto_v1_1_0_combat_battle_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type BattleReward struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	Exp   int32                  `protobuf:"varint,1,opt,name=exp,proto3" json:"exp,omitempty"`     // 经验值
	...
	Honor int32                  `protobuf:"varint,4,opt,name=honor,proto3" json:"honor,omitempty"` // 荣誉值
	// v1.1.0 新增字段
...
func (x *BattleReward) Reset() {
	*x = BattleReward{}
	mi := &file_slg_proto_v1_1_0_combat_battle_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type UnitBuff struct {
	...
	IsDispellable bool   `protobuf:"varint,7,opt,name=is_dispellable,json=isDispellable,proto3" json:"is_dispellable,omitempty"`  // 是否可驱散
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UnitBuff) Reset() {
	*x = UnitBuff{}
	mi := &file_slg_proto_v1_1_0_combat_battle_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type UnitStats struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	Attack         int32                  `protobuf:"varint,1,opt,name=attack,proto3" json:"attack,omitempty"`                                       // 攻击力
	Defense        int32                  `protobuf:"varint,2,opt,name=defense,proto3" json:"defense,omitempty"`                                     // 防御力
	Speed          int32                  `protobuf:"varint,3,opt,name=speed,proto3" json:"speed,omitempty"`                                         // 速度
	CriticalRate   int32                  `protobuf:"varint,4,opt,name=critical_rate,json=criticalRate,proto3" json:"critical_rate,omitempty"`       // 暴击率(千分比)
	CriticalDamage int32                  `protobuf:"varint,5,opt,name=critical_damage,json=criticalDamage,proto3" json:"critical_damage,omitempty"` // 暴击伤害(千分比)
	Accuracy       int32                  `protobuf:"varint,6,opt,name=accuracy,proto3" json:"accuracy,omitempty"`                                   // 命中率(千分比)
	Dodge          int32                  `protobuf:"varint,7,opt,name=dodge,proto3" json:"dodge,omitempty"`                                         // 闪避率(千分比)
	// v1.1.0 新增字段
	MagicAttack   int32 `protobuf:"varint,8,opt,name=magic_attack,json=magicAttack,proto3" json:"magic_attack,omitempty"`    // 魔法攻击力
	MagicDefense  int32 `protobuf:"varint,9,opt,name=magic_defense,json=magicDefense,proto3" json:"magic_defense,omitempty"` // 魔法防御力
	Penetration   int32 `protobuf:"varint,10,opt,name=penetration,proto3" json:"penetration,omitempty"`                      // 穿透力
	Block         int32 `protobuf:"varint,11,opt,name=block,proto3" json:"block,omitempty"`                                  // 格挡率
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UnitStats) Reset() {
	*x = UnitStats{}
	mi := &file_slg_proto_v1_1_0_combat_battle_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UnitStats) Descriptor() ([]byte, []int) {
	return file_slg_proto_v1_1_0_combat_battle_proto_rawDescGZIP(), []int{7}
}
...
type BattleStatistics struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	TotalDamageDealt int32                  `protobuf:"varint,1,opt,name=total_damage_dealt,json=totalDamageDealt,proto3" json:"total_damage_dealt,omitempty"`                                                       // 总伤害输出
	...
	KillsCount       int32                  `protobuf:"varint,3,opt,name=kills_count,json=killsCount,proto3" json:"kills_count,omitempty"`                                                                           // 击杀数
	DeathsCount      int32                  `protobuf:"varint,4,opt,name=deaths_count,json=deathsCount,proto3" json:"deaths_count,omitempty"`                                                                        // 死亡数
	AssistsCount     int32                  `protobuf:"varint,5,opt,name=assists_count,json=assistsCount,proto3" json:"assists_count,omitempty"`                                                                     // 助攻数
	SkillUsage       map[string]int32       `protobuf:"bytes,6,rep,name=skill_usage,json=skillUsage,proto3" json:"skill_usage,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"` // 技能使用统计
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *BattleStatistics) Reset() {
	*x = BattleStatistics{}
	mi := &file_slg_proto_v1_1_0_combat_battle_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BattleStatistics) Descriptor() ([]byte, []int) {
	return file_slg_proto_v1_1_0_combat_battle_proto_rawDescGZIP(), []int{8}
}
...
type EnvironmentEffect struct {
	...
	EffectType    EnvironmentType        `protobuf:"varint,2,opt,name=effect_type,json=effectType,proto3,enum=slg.combat.v1.EnvironmentType" json:"effect_type,omitempty"`                                               // 环境类型
	Duration      int32                  `protobuf:"varint,3,opt,name=duration,proto3" json:"duration,omitempty"`                                                                                                        // 持续时间
	AffectedUnits []string               `protobuf:"bytes,4,rep,name=affected_units,json=affectedUnits,proto3" json:"affected_units,omitempty"`                                                                          // 受影响单位
...
func (x *EnvironmentEffect) Reset() {
	*x = EnvironmentEffect{}
	mi := &file_slg_proto_v1_1_0_combat_battle_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*EnvironmentEffect) Descriptor() ([]byte, []int) {
	return file_slg_proto_v1_1_0_combat_battle_proto_rawDescGZIP(), []int{9}
}
...
func (x *UnitEquipment) Reset() {
	*x = UnitEquipment{}
	mi := &file_slg_proto_v1_1_0_combat_battle_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UnitEquipment) Descriptor() ([]byte, []int) {
	return file_slg_proto_v1_1_0_combat_battle_proto_rawDescGZIP(), []int{10}
}
...
var File_slg_proto_v1_1_0_combat_battle_proto protoreflect.FileDescriptor

const file_slg_proto_v1_1_0_combat_battle_proto_rawDesc = "" +
	"\n" +
	"$slg-proto/v1.1.0/combat/battle.proto\x12\rslg.combat.v1\x1a#slg-proto/v1.1.0/common/types.proto\"\xdc\x03\n" +
	...
	"\fformation_id\x18\a \x01(\tR\vformationId\x12Y\n" +
	"\x0fbattle_settings\x18\b \x03(\v20.slg.combat.v1.BattleRequest.BattleSettingsEntryR\x0ebattleSettings\x12#\n" +
	"\rpreset_skills\x18\t \x03(\tR\fpresetSkills\x1aA\n" +
	"\x13BattleSettingsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x05R\x05value:\x028\x01\"\xf5\x02\n" +
	...
	"durationMs\x12?\n" +
	"\n" +
	"statistics\x18\x06 \x01(\v2\x1f.slg.combat.v1.BattleStatisticsR\n" +
	"statistics\x12\x1b\n" +
	...
	"\ttimestamp\x18\x05 \x01(\x03R\ttimestamp\x12B\n" +
	"\venvironment\x18\x06 \x01(\v2 .slg.combat.v1.EnvironmentEffectR\venvironment\x12#\n" +
	"\ractive_skills\x18\a \x03(\tR\factiveSkills\"\xf9\x03\n" +
	"\n" +
	"BattleUnit\x12\x17\n" +
	...
	"\x05stats\x18\n" +
	" \x01(\v2\x18.slg.combat.v1.UnitStatsR\x05stats\x12)\n" +
	...
	"\tequipment\x18\x0e \x01(\v2\x1c.slg.combat.v1.UnitEquipmentR\tequipment\"\xca\x03\n" +
	...
	"\n" +
	"target_pos\x18\b \x01(\v2\x17.slg.common.v1.PositionR\ttargetPos\x12\x19\n" +
	"\bskill_id\x18\t \x01(\tR\askillId\x12\x1f\n" +
	"\vis_critical\x18\n" +
	" \x01(\bR\n" +
	"isCritical\x12+\n" +
	"\x11damage_multiplier\x18\v \x01(\x02R\x10damageMultiplier\x12!\n" +
	"\fcombo_skills\x18\f \x03(\tR\vcomboSkills\"\xe7\x01\n" +
	...
	"\x12guild_contribution\x18\a \x01(\x05R\x11guildContribution\"\xf6\x02\n" +
	"\bUnitBuff\x12\x17\n" +
	...
	"stackCount\x12N\n" +
	"\reffect_values\x18\x05 \x03(\v2).slg.combat.v1.UnitBuff.EffectValuesEntryR\feffectValues\x12&\n" +
	...
	"\x05block\x18\v \x01(\x05R\x05block\"\xe8\x02\n" +
	...
	"\rassists_count\x18\x05 \x01(\x05R\fassistsCount\x12P\n" +
	"\vskill_usage\x18\x06 \x03(\v2/.slg.combat.v1.BattleStatistics.SkillUsageEntryR\n" +
	"skillUsage\x1a=\n" +
	...
	"\veffect_type\x18\x02 \x01(\x0e2\x1e.slg.combat.v1.EnvironmentTypeR\n" +
	"effectType\x12\x1a\n" +
	"\bduration\x18\x03 \x01(\x05R\bduration\x12%\n" +
	"\x0eaffected_units\x18\x04 \x03(\tR\raffectedUnits\x12W\n" +
	"\reffect_params\x18\x05 \x03(\v22.slg.combat.v1.EnvironmentEffect.EffectParamsEntryR\feffectParams\x1a?\n" +
	...
	"\x1cENVIRONMENT_TYPE_MAGIC_FIELD\x10\x04B7Z5GoSlgBenchmarkTest/generated/slg/v1_1_0/combat;combatb\x06proto3"

var (
	file_slg_proto_v1_1_0_combat_battle_proto_rawDescOnce sync.Once
	file_slg_proto_v1_1_0_combat_battle_proto_rawDescData []byte
)

func file_slg_proto_v1_1_0_combat_battle_proto_rawDescGZIP() []byte {
	file_slg_proto_v1_1_0_combat_battle_proto_rawDescOnce.Do(func() {
		file_slg_proto_v1_1_0_combat_battle_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_slg_proto_v1_1_0_combat_battle_proto_rawDesc), len(file_slg_proto_v1_1_0_combat_battle_proto_rawDesc)))
	})
	return file_slg_proto_v1_1_0_combat_battle_proto_rawDescData
}

var file_slg_proto_v1_1_0_combat_battle_proto_enumTypes = make([]protoimpl.EnumInfo, 7)
var file_slg_proto_v1_1_0_combat_battle_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_slg_proto_v1_1_0_combat_battle_proto_goTypes = []any{
	...
	(EnvironmentType)(0),      // 6: slg.combat.v1.EnvironmentType
	(*BattleRequest)(nil),     // 7: slg.combat.v1.BattleRequest
	(*BattleResponse)(nil),    // 8: slg.combat.v1.BattleResponse
	(*BattleStatePush)(nil),   // 9: slg.combat.v1.BattleStatePush
	(*BattleUnit)(nil),        // 10: slg.combat.v1.BattleUnit
	(*BattleAction)(nil),      // 11: slg.combat.v1.BattleAction
	(*BattleReward)(nil),      // 12: slg.combat.v1.BattleReward
	(*UnitBuff)(nil),          // 13: slg.combat.v1.UnitBuff
	(*UnitStats)(nil),         // 14: slg.combat.v1.UnitStats
	(*BattleStatistics)(nil),  // 15: slg.combat.v1.BattleStatistics
	(*EnvironmentEffect)(nil), // 16: slg.combat.v1.EnvironmentEffect
	(*UnitEquipment)(nil),     // 17: slg.combat.v1.UnitEquipment
	nil,                       // 18: slg.combat.v1.BattleRequest.BattleSettingsEntry
	nil,                       // 19: slg.combat.v1.UnitBuff.EffectValuesEntry
	nil,                       // 20: slg.combat.v1.BattleStatistics.SkillUsageEntry
	nil,                       // 21: slg.combat.v1.EnvironmentEffect.EffectParamsEntry
	(*common.Position)(nil),   // 22: slg.common.v1.Position
	(*common.Item)(nil),       // 23: slg.common.v1.Item
}
var file_slg_proto_v1_1_0_combat_battle_proto_depIdxs = []int32{
	0,  // 0: slg.combat.v1.BattleRequest.battle_type:type_name -> slg.combat.v1.BattleType
	22, // 1: slg.combat.v1.BattleRequest.target_pos:type_name -> slg.common.v1.Position
	18, // 2: slg.combat.v1.BattleRequest.battle_settings:type_name -> slg.combat.v1.BattleRequest.BattleSettingsEntry
	1,  // 3: slg.combat.v1.BattleResponse.result:type_name -> slg.combat.v1.BattleResult
	10, // 4: slg.combat.v1.BattleResponse.battle_units:type_name -> slg.combat.v1.BattleUnit
	12, // 5: slg.combat.v1.BattleResponse.reward:type_name -> slg.combat.v1.BattleReward
	15, // 6: slg.combat.v1.BattleResponse.statistics:type_name -> slg.combat.v1.BattleStatistics
	11, // 7: slg.combat.v1.BattleStatePush.actions:type_name -> slg.combat.v1.BattleAction
	2,  // 8: slg.combat.v1.BattleStatePush.phase:type_name -> slg.combat.v1.BattlePhase
	16, // 9: slg.combat.v1.BattleStatePush.environment:type_name -> slg.combat.v1.EnvironmentEffect
	22, // 10: slg.combat.v1.BattleUnit.position:type_name -> slg.common.v1.Position
	3,  // 11: slg.combat.v1.BattleUnit.status:type_name -> slg.combat.v1.UnitStatus
	13, // 12: slg.combat.v1.BattleUnit.buffs:type_name -> slg.combat.v1.UnitBuff
	14, // 13: slg.combat.v1.BattleUnit.stats:type_name -> slg.combat.v1.UnitStats
	17, // 14: slg.combat.v1.BattleUnit.equipment:type_name -> slg.combat.v1.UnitEquipment
	4,  // 15: slg.combat.v1.BattleAction.action_type:type_name -> slg.combat.v1.ActionType
	22, // 16: slg.combat.v1.BattleAction.target_pos:type_name -> slg.common.v1.Position
	23, // 17: slg.combat.v1.BattleReward.items:type_name -> slg.common.v1.Item
	5,  // 18: slg.combat.v1.UnitBuff.buff_type:type_name -> slg.combat.v1.BuffType
	19, // 19: slg.combat.v1.UnitBuff.effect_values:type_name -> slg.combat.v1.UnitBuff.EffectValuesEntry
	20, // 20: slg.combat.v1.BattleStatistics.skill_usage:type_name -> slg.combat.v1.BattleStatistics.SkillUsageEntry
	6,  // 21: slg.combat.v1.EnvironmentEffect.effect_type:type_name -> slg.combat.v1.EnvironmentType
	21, // 22: slg.combat.v1.EnvironmentEffect.effect_params:type_name -> slg.combat.v1.EnvironmentEffect.EffectParamsEntry
...
func init() { file_slg_proto_v1_1_0_combat_battle_proto_init() }
func file_slg_proto_v1_1_0_combat_battle_proto_init() {
	if File_slg_proto_v1_1_0_combat_battle_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_slg_proto_v1_1_0_combat_battle_proto_rawDesc), len(file_slg_proto_v1_1_0_combat_battle_proto_rawDesc)),
			NumEnums:      7,
			NumMessages:   15,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_slg_proto_v1_1_0_combat_battle_proto_goTypes,
		DependencyIndexes: file_slg_proto_v1_1_0_combat_battle_proto_depIdxs,
		EnumInfos:         file_slg_proto_v1_1_0_combat_battle_proto_enumTypes,
		MessageInfos:      file_slg_proto_v1_1_0_combat_battle_proto_msgTypes,
	}.Build()
	File_slg_proto_v1_1_0_combat_battle_proto = out.File
	file_slg_proto_v1_1_0_combat_battle_proto_goTypes = nil
	file_slg_proto_v1_1_0_combat_battle_proto_depIdxs = nil
}
