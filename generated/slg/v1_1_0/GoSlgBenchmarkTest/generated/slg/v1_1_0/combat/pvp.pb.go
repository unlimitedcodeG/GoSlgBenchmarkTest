...
// 	protoc        v5.29.3
// source: slg-proto/v1.1.0/combat/pvp.proto
...
const (
	...
	PvpMode_PVP_MODE_TOURNAMENT PvpMode = 5 // 锦标赛
	PvpMode_PVP_MODE_GUILD_WAR  PvpMode = 6 // 公会战
)
...
func (PvpMode) Descriptor() protoreflect.EnumDescriptor {
	return file_slg_proto_v1_1_0_combat_pvp_proto_enumTypes[0].Descriptor()
}

func (PvpMode) Type() protoreflect.EnumType {
	return &file_slg_proto_v1_1_0_combat_pvp_proto_enumTypes[0]
}
...
func (PvpMode) EnumDescriptor() ([]byte, []int) {
	return file_slg_proto_v1_1_0_combat_pvp_proto_rawDescGZIP(), []int{0}
}
...
func (PvpMatchResult) Descriptor() protoreflect.EnumDescriptor {
	return file_slg_proto_v1_1_0_combat_pvp_proto_enumTypes[1].Descriptor()
}

func (PvpMatchResult) Type() protoreflect.EnumType {
	return &file_slg_proto_v1_1_0_combat_pvp_proto_enumTypes[1]
}
...
func (PvpMatchResult) EnumDescriptor() ([]byte, []int) {
	return file_slg_proto_v1_1_0_combat_pvp_proto_rawDescGZIP(), []int{1}
}
...
func (PvpEndReason) Descriptor() protoreflect.EnumDescriptor {
	return file_slg_proto_v1_1_0_combat_pvp_proto_enumTypes[2].Descriptor()
}

func (PvpEndReason) Type() protoreflect.EnumType {
	return &file_slg_proto_v1_1_0_combat_pvp_proto_enumTypes[2]
}
...
func (PvpEndReason) EnumDescriptor() ([]byte, []int) {
	return file_slg_proto_v1_1_0_combat_pvp_proto_rawDescGZIP(), []int{2}
}
...
func (PvpTier) Descriptor() protoreflect.EnumDescriptor {
	return file_slg_proto_v1_1_0_combat_pvp_proto_enumTypes[3].Descriptor()
}

func (PvpTier) Type() protoreflect.EnumType {
	return &file_slg_proto_v1_1_0_combat_pvp_proto_enumTypes[3]
}
...
func (PvpTier) EnumDescriptor() ([]byte, []int) {
	return file_slg_proto_v1_1_0_combat_pvp_proto_rawDescGZIP(), []int{3}
}
...
func (PvpLeaderboardType) Descriptor() protoreflect.EnumDescriptor {
	return file_slg_proto_v1_1_0_combat_pvp_proto_enumTypes[4].Descriptor()
}

func (PvpLeaderboardType) Type() protoreflect.EnumType {
	return &file_slg_proto_v1_1_0_combat_pvp_proto_enumTypes[4]
}
...
func (PvpLeaderboardType) EnumDescriptor() ([]byte, []int) {
	return file_slg_proto_v1_1_0_combat_pvp_proto_rawDescGZIP(), []int{4}
}
...
const (
	...
	PvpSeasonStatus_PVP_SEASON_STATUS_UPCOMING PvpSeasonStatus = 1 // 即将开始
	PvpSeasonStatus_PVP_SEASON_STATUS_ACTIVE   PvpSeasonStatus = 2 // 进行中
	PvpSeasonStatus_PVP_SEASON_STATUS_ENDING   PvpSeasonStatus = 3 // 即将结束
	PvpSeasonStatus_PVP_SEASON_STATUS_ENDED    PvpSeasonStatus = 4 // 已结束
)
...
func (PvpSeasonStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_slg_proto_v1_1_0_combat_pvp_proto_enumTypes[5].Descriptor()
}

func (PvpSeasonStatus) Type() protoreflect.EnumType {
	return &file_slg_proto_v1_1_0_combat_pvp_proto_enumTypes[5]
}
...
func (PvpSeasonStatus) EnumDescriptor() ([]byte, []int) {
	return file_slg_proto_v1_1_0_combat_pvp_proto_rawDescGZIP(), []int{5}
}
...
type PvpMatchRequest struct {
	...
	Mode          PvpMode                `protobuf:"varint,2,opt,name=mode,proto3,enum=slg.combat.v1.PvpMode" json:"mode,omitempty"`            // PVP模式
...
func (x *PvpMatchRequest) Reset() {
	*x = PvpMatchRequest{}
	mi := &file_slg_proto_v1_1_0_combat_pvp_proto_msgTypes[0]
...
type PvpMatchResponse struct {
	...
	Result            PvpMatchResult         `protobuf:"varint,2,opt,name=result,proto3,enum=slg.combat.v1.PvpMatchResult" json:"result,omitempty"`                // 匹配结果
	...
	EstimatedWaitTime int32                  `protobuf:"varint,6,opt,name=estimated_wait_time,json=estimatedWaitTime,proto3" json:"estimated_wait_time,omitempty"` // 预估等待时间(秒)
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *PvpMatchResponse) Reset() {
	*x = PvpMatchResponse{}
	mi := &file_slg_proto_v1_1_0_combat_pvp_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type PvpBattleResult struct {
	...
	BattleDuration int32                  `protobuf:"varint,5,opt,name=battle_duration,json=battleDuration,proto3" json:"battle_duration,omitempty"`                  // 战斗时长(秒)
	EndReason      PvpEndReason           `protobuf:"varint,6,opt,name=end_reason,json=endReason,proto3,enum=slg.combat.v1.PvpEndReason" json:"end_reason,omitempty"` // 结束原因
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *PvpBattleResult) Reset() {
	*x = PvpBattleResult{}
	mi := &file_slg_proto_v1_1_0_combat_pvp_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type PvpLeaderboardRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Type          PvpLeaderboardType     `protobuf:"varint,1,opt,name=type,proto3,enum=slg.combat.v1.PvpLeaderboardType" json:"type,omitempty"` // 排行榜类型
...
func (x *PvpLeaderboardRequest) Reset() {
	*x = PvpLeaderboardRequest{}
	mi := &file_slg_proto_v1_1_0_combat_pvp_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type PvpLeaderboardResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Entries       []*PvpRankEntry        `protobuf:"bytes,1,rep,name=entries,proto3" json:"entries,omitempty"`                                     // 排行榜条目
	TotalCount    int32                  `protobuf:"varint,2,opt,name=total_count,json=totalCount,proto3" json:"total_count,omitempty"`            // 总数量
	PlayerRank    *PvpPlayerRank         `protobuf:"bytes,3,opt,name=player_rank,json=playerRank,proto3" json:"player_rank,omitempty"`             // 玩家自己的排名
...
func (x *PvpLeaderboardResponse) Reset() {
	*x = PvpLeaderboardResponse{}
	mi := &file_slg_proto_v1_1_0_combat_pvp_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type PvpSeasonInfo struct {
	...
	Status        PvpSeasonStatus        `protobuf:"varint,5,opt,name=status,proto3,enum=slg.combat.v1.PvpSeasonStatus" json:"status,omitempty"`                                                                     // 赛季状态
...
func (x *PvpSeasonInfo) Reset() {
	*x = PvpSeasonInfo{}
	mi := &file_slg_proto_v1_1_0_combat_pvp_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type PvpPlayer struct {
	...
	Tier          PvpTier                `protobuf:"varint,4,opt,name=tier,proto3,enum=slg.combat.v1.PvpTier" json:"tier,omitempty"`   // 段位
	WinCount      int32                  `protobuf:"varint,5,opt,name=win_count,json=winCount,proto3" json:"win_count,omitempty"`      // 胜场数
	LoseCount     int32                  `protobuf:"varint,6,opt,name=lose_count,json=loseCount,proto3" json:"lose_count,omitempty"`   // 败场数
...
func (x *PvpPlayer) Reset() {
	*x = PvpPlayer{}
	mi := &file_slg_proto_v1_1_0_combat_pvp_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PvpPlayer) Descriptor() ([]byte, []int) {
	return file_slg_proto_v1_1_0_combat_pvp_proto_rawDescGZIP(), []int{6}
}
...
type PvpPlayerResult struct {
	...
	OldTier       PvpTier                `protobuf:"varint,4,opt,name=old_tier,json=oldTier,proto3,enum=slg.combat.v1.PvpTier" json:"old_tier,omitempty"` // 旧段位
	NewTier       PvpTier                `protobuf:"varint,5,opt,name=new_tier,json=newTier,proto3,enum=slg.combat.v1.PvpTier" json:"new_tier,omitempty"` // 新段位
...
func (x *PvpPlayerResult) Reset() {
	*x = PvpPlayerResult{}
	mi := &file_slg_proto_v1_1_0_combat_pvp_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PvpPlayerResult) Descriptor() ([]byte, []int) {
	return file_slg_proto_v1_1_0_combat_pvp_proto_rawDescGZIP(), []int{7}
}
...
type PvpRankEntry struct {
	...
	Streak        int32                  `protobuf:"varint,4,opt,name=streak,proto3" json:"streak,omitempty"` // 连胜/连败数
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *PvpRankEntry) Reset() {
	*x = PvpRankEntry{}
	mi := &file_slg_proto_v1_1_0_combat_pvp_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PvpRankEntry) Descriptor() ([]byte, []int) {
	return file_slg_proto_v1_1_0_combat_pvp_proto_rawDescGZIP(), []int{8}
}
...
type PvpPlayerRank struct {
	...
	BestRank      int32                  `protobuf:"varint,2,opt,name=best_rank,json=bestRank,proto3" json:"best_rank,omitempty"`          // 最佳排名
	Rating        int32                  `protobuf:"varint,3,opt,name=rating,proto3" json:"rating,omitempty"`                              // 当前评分
	BestRating    int32                  `protobuf:"varint,4,opt,name=best_rating,json=bestRating,proto3" json:"best_rating,omitempty"`    // 历史最高评分
	Tier          PvpTier                `protobuf:"varint,5,opt,name=tier,proto3,enum=slg.combat.v1.PvpTier" json:"tier,omitempty"`       // 当前段位
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *PvpPlayerRank) Reset() {
	*x = PvpPlayerRank{}
	mi := &file_slg_proto_v1_1_0_combat_pvp_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PvpPlayerRank) Descriptor() ([]byte, []int) {
	return file_slg_proto_v1_1_0_combat_pvp_proto_rawDescGZIP(), []int{9}
}
...
type PvpReward struct {
	...
	PvpCoins      int32                  `protobuf:"varint,2,opt,name=pvp_coins,json=pvpCoins,proto3" json:"pvp_coins,omitempty"`          // PVP币
	...
	Experience    int32                  `protobuf:"varint,5,opt,name=experience,proto3" json:"experience,omitempty"`                      // 经验值
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *PvpReward) Reset() {
	*x = PvpReward{}
	mi := &file_slg_proto_v1_1_0_combat_pvp_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PvpReward) Descriptor() ([]byte, []int) {
	return file_slg_proto_v1_1_0_combat_pvp_proto_rawDescGZIP(), []int{10}
}
...
func (x *PvpAchievement) Reset() {
	*x = PvpAchievement{}
	mi := &file_slg_proto_v1_1_0_combat_pvp_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PvpAchievement) Descriptor() ([]byte, []int) {
	return file_slg_proto_v1_1_0_combat_pvp_proto_rawDescGZIP(), []int{11}
}
...
var File_slg_proto_v1_1_0_combat_pvp_proto protoreflect.FileDescriptor

const file_slg_proto_v1_1_0_combat_pvp_proto_rawDesc = "" +
	"\n" +
	"!slg-proto/v1.1.0/combat/pvp.proto\x12\rslg.combat.v1\x1a#slg-proto/v1.1.0/common/types.proto\"\xbd\x01\n" +
	"\x0fPvpMatchRequest\x12\x1b\n" +
	"\tplayer_id\x18\x01 \x01(\tR\bplayerId\x12*\n" +
	"\x04mode\x18\x02 \x01(\x0e2\x16.slg.combat.v1.PvpModeR\x04mode\x12!\n" +
	"\frating_range\x18\x03 \x01(\x05R\vratingRange\x12%\n" +
	"\x0epreferred_maps\x18\x04 \x03(\tR\rpreferredMaps\x12\x17\n" +
	"\ateam_id\x18\x05 \x01(\tR\x06teamId\"\xfe\x01\n" +
	"\x10PvpMatchResponse\x12\x19\n" +
	"\bmatch_id\x18\x01 \x01(\tR\amatchId\x125\n" +
	"\x06result\x18\x02 \x01(\x0e2\x1d.slg.combat.v1.PvpMatchResultR\x06result\x122\n" +
	"\aplayers\x18\x03 \x03(\v2\x18.slg.combat.v1.PvpPlayerR\aplayers\x12\x15\n" +
	"\x06map_id\x18\x04 \x01(\tR\x05mapId\x12\x1d\n" +
	"\n" +
	"start_time\x18\x05 \x01(\x03R\tstartTime\x12.\n" +
	"\x13estimated_wait_time\x18\x06 \x01(\x05R\x11estimatedWaitTime\"\xa8\x02\n" +
	"\x0fPvpBattleResult\x12\x19\n" +
	"\bmatch_id\x18\x01 \x01(\tR\amatchId\x12(\n" +
	"\x10winner_player_id\x18\x02 \x01(\tR\x0ewinnerPlayerId\x12$\n" +
	"\x0ewinner_team_id\x18\x03 \x01(\tR\fwinnerTeamId\x12E\n" +
	"\x0eplayer_results\x18\x04 \x03(\v2\x1e.slg.combat.v1.PvpPlayerResultR\rplayerResults\x12'\n" +
	"\x0fbattle_duration\x18\x05 \x01(\x05R\x0ebattleDuration\x12:\n" +
	"\n" +
	"end_reason\x18\x06 \x01(\x0e2\x1b.slg.combat.v1.PvpEndReasonR\tendReason\"\x9c\x01\n" +
	"\x15PvpLeaderboardRequest\x125\n" +
	"\x04type\x18\x01 \x01(\x0e2!.slg.combat.v1.PvpLeaderboardTypeR\x04type\x12\x12\n" +
	"\x04page\x18\x02 \x01(\x05R\x04page\x12\x1b\n" +
	"\tpage_size\x18\x03 \x01(\x05R\bpageSize\x12\x1b\n" +
	"\tseason_id\x18\x04 \x01(\tR\bseasonId\"\xf4\x01\n" +
	"\x16PvpLeaderboardResponse\x125\n" +
	"\aentries\x18\x01 \x03(\v2\x1b.slg.combat.v1.PvpRankEntryR\aentries\x12\x1f\n" +
	"\vtotal_count\x18\x02 \x01(\x05R\n" +
	"totalCount\x12=\n" +
	"\vplayer_rank\x18\x03 \x01(\v2\x1c.slg.combat.v1.PvpPlayerRankR\n" +
	"playerRank\x12\x1b\n" +
	"\tseason_id\x18\x04 \x01(\tR\bseasonId\x12&\n" +
	"\x0fseason_end_time\x18\x05 \x01(\x03R\rseasonEndTime\"\x92\x03\n" +
	...
	"\bend_time\x18\x04 \x01(\x03R\aendTime\x126\n" +
	"\x06status\x18\x05 \x01(\x0e2\x1e.slg.combat.v1.PvpSeasonStatusR\x06status\x12?\n" +
	"\x0eseason_rewards\x18\x06 \x03(\v2\x18.slg.combat.v1.PvpRewardR\rseasonRewards\x12P\n" +
	"\frating_tiers\x18\a \x03(\v2-.slg.combat.v1.PvpSeasonInfo.RatingTiersEntryR\vratingTiers\x1a>\n" +
	...
	"\x04tier\x18\x04 \x01(\x0e2\x16.slg.combat.v1.PvpTierR\x04tier\x12\x1b\n" +
	...
	"\n" +
	"guild_name\x18\b \x01(\tR\tguildName\"\xcb\x02\n" +
	"\x0fPvpPlayerResult\x12\x1b\n" +
	"\tplayer_id\x18\x01 \x01(\tR\bplayerId\x12\x1b\n" +
	"\tis_winner\x18\x02 \x01(\bR\bisWinner\x12#\n" +
	"\rrating_change\x18\x03 \x01(\x05R\fratingChange\x121\n" +
	"\bold_tier\x18\x04 \x01(\x0e2\x16.slg.combat.v1.PvpTierR\aoldTier\x121\n" +
	"\bnew_tier\x18\x05 \x01(\x0e2\x16.slg.combat.v1.PvpTierR\anewTier\x120\n" +
	"\x06reward\x18\x06 \x01(\v2\x18.slg.combat.v1.PvpRewardR\x06reward\x12A\n" +
	"\fachievements\x18\a \x03(\v2\x1d.slg.combat.v1.PvpAchievementR\fachievements\"\x84\x01\n" +
	"\fPvpRankEntry\x12\x12\n" +
	"\x04rank\x18\x01 \x01(\x05R\x04rank\x120\n" +
	"\x06player\x18\x02 \x01(\v2\x18.slg.combat.v1.PvpPlayerR\x06player\x12\x16\n" +
	"\x06points\x18\x03 \x01(\x05R\x06points\x12\x16\n" +
	"\x06streak\x18\x04 \x01(\x05R\x06streak\"\xb4\x01\n" +
	"\rPvpPlayerRank\x12!\n" +
	...
	"bestRating\x12*\n" +
	"\x04tier\x18\x05 \x01(\x0e2\x16.slg.combat.v1.PvpTierR\x04tier\"\xb1\x01\n" +
	"\tPvpReward\x12!\n" +
	"\fhonor_points\x18\x01 \x01(\x05R\vhonorPoints\x12\x1b\n" +
	"\tpvp_coins\x18\x02 \x01(\x05R\bpvpCoins\x12)\n" +
	"\x05items\x18\x03 \x03(\v2\x13.slg.common.v1.ItemR\x05items\x12\x19\n" +
	...
	"unlockTime\x120\n" +
	"\x06reward\x18\x04 \x01(\v2\x18.slg.combat.v1.PvpRewardR\x06reward*\xb4\x01\n" +
	"\aPvpMode\x12\x14\n" +
	...
	"\x17PVP_SEASON_STATUS_ENDED\x10\x04B7Z5GoSlgBenchmarkTest/generated/slg/v1_1_0/combat;combatb\x06proto3"

var (
	file_slg_proto_v1_1_0_combat_pvp_proto_rawDescOnce sync.Once
	file_slg_proto_v1_1_0_combat_pvp_proto_rawDescData []byte
)

func file_slg_proto_v1_1_0_combat_pvp_proto_rawDescGZIP() []byte {
	file_slg_proto_v1_1_0_combat_pvp_proto_rawDescOnce.Do(func() {
		file_slg_proto_v1_1_0_combat_pvp_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_slg_proto_v1_1_0_combat_pvp_proto_rawDesc), len(file_slg_proto_v1_1_0_combat_pvp_proto_rawDesc)))
	})
	return file_slg_proto_v1_1_0_combat_pvp_proto_rawDescData
}

var file_slg_proto_v1_1_0_combat_pvp_proto_enumTypes = make([]protoimpl.EnumInfo, 6)
var file_slg_proto_v1_1_0_combat_pvp_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_slg_proto_v1_1_0_combat_pvp_proto_goTypes = []any{
	(PvpMode)(0),                   // 0: slg.combat.v1.PvpMode
	(PvpMatchResult)(0),            // 1: slg.combat.v1.PvpMatchResult
	(PvpEndReason)(0),              // 2: slg.combat.v1.PvpEndReason
	(PvpTier)(0),                   // 3: slg.combat.v1.PvpTier
	(PvpLeaderboardType)(0),        // 4: slg.combat.v1.PvpLeaderboardType
	(PvpSeasonStatus)(0),           // 5: slg.combat.v1.PvpSeasonStatus
	(*PvpMatchRequest)(nil),        // 6: slg.combat.v1.PvpMatchRequest
	(*PvpMatchResponse)(nil),       // 7: slg.combat.v1.PvpMatchResponse
	(*PvpBattleResult)(nil),        // 8: slg.combat.v1.PvpBattleResult
	(*PvpLeaderboardRequest)(nil),  // 9: slg.combat.v1.PvpLeaderboardRequest
	(*PvpLeaderboardResponse)(nil), // 10: slg.combat.v1.PvpLeaderboardResponse
	(*PvpSeasonInfo)(nil),          // 11: slg.combat.v1.PvpSeasonInfo
	(*PvpPlayer)(nil),              // 12: slg.combat.v1.PvpPlayer
	(*PvpPlayerResult)(nil),        // 13: slg.combat.v1.PvpPlayerResult
	(*PvpRankEntry)(nil),           // 14: slg.combat.v1.PvpRankEntry
	(*PvpPlayerRank)(nil),          // 15: slg.combat.v1.PvpPlayerRank
	(*PvpReward)(nil),              // 16: slg.combat.v1.PvpReward
	(*PvpAchievement)(nil),         // 17: slg.combat.v1.PvpAchievement
	nil,                            // 18: slg.combat.v1.PvpSeasonInfo.RatingTiersEntry
	(*common.Item)(nil),            // 19: slg.common.v1.Item
}
var file_slg_proto_v1_1_0_combat_pvp_proto_depIdxs = []int32{
	0,  // 0: slg.combat.v1.PvpMatchRequest.mode:type_name -> slg.combat.v1.PvpMode
	1,  // 1: slg.combat.v1.PvpMatchResponse.result:type_name -> slg.combat.v1.PvpMatchResult
	12, // 2: slg.combat.v1.PvpMatchResponse.players:type_name -> slg.combat.v1.PvpPlayer
	13, // 3: slg.combat.v1.PvpBattleResult.player_results:type_name -> slg.combat.v1.PvpPlayerResult
	2,  // 4: slg.combat.v1.PvpBattleResult.end_reason:type_name -> slg.combat.v1.PvpEndReason
	4,  // 5: slg.combat.v1.PvpLeaderboardRequest.type:type_name -> slg.combat.v1.PvpLeaderboardType
	14, // 6: slg.combat.v1.PvpLeaderboardResponse.entries:type_name -> slg.combat.v1.PvpRankEntry
	15, // 7: slg.combat.v1.PvpLeaderboardResponse.player_rank:type_name -> slg.combat.v1.PvpPlayerRank
	5,  // 8: slg.combat.v1.PvpSeasonInfo.status:type_name -> slg.combat.v1.PvpSeasonStatus
	16, // 9: slg.combat.v1.PvpSeasonInfo.season_rewards:type_name -> slg.combat.v1.PvpReward
	18, // 10: slg.combat.v1.PvpSeasonInfo.rating_tiers:type_name -> slg.combat.v1.PvpSeasonInfo.RatingTiersEntry
	3,  // 11: slg.combat.v1.PvpPlayer.tier:type_name -> slg.combat.v1.PvpTier
	3,  // 12: slg.combat.v1.PvpPlayerResult.old_tier:type_name -> slg.combat.v1.PvpTier
	3,  // 13: slg.combat.v1.PvpPlayerResult.new_tier:type_name -> slg.combat.v1.PvpTier
	16, // 14: slg.combat.v1.PvpPlayerResult.reward:type_name -> slg.combat.v1.PvpReward
	17, // 15: slg.combat.v1.PvpPlayerResult.achievements:type_name -> slg.combat.v1.PvpAchievement
	12, // 16: slg.combat.v1.PvpRankEntry.player:type_name -> slg.combat.v1.PvpPlayer
	3,  // 17: slg.combat.v1.PvpPlayerRank.tier:type_name -> slg.combat.v1.PvpTier
	19, // 18: slg.combat.v1.PvpReward.items:type_name -> slg.common.v1.Item
	16, // 19: slg.combat.v1.PvpAchievement.reward:type_name -> slg.combat.v1.PvpReward
...
func init() { file_slg_proto_v1_1_0_combat_pvp_proto_init() }
func file_slg_proto_v1_1_0_combat_pvp_proto_init() {
	if File_slg_proto_v1_1_0_combat_pvp_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_slg_proto_v1_1_0_combat_pvp_proto_rawDesc), len(file_slg_proto_v1_1_0_combat_pvp_proto_rawDesc)),
			NumEnums:      6,
			NumMessages:   13,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_slg_proto_v1_1_0_combat_pvp_proto_goTypes,
		DependencyIndexes: file_slg_proto_v1_1_0_combat_pvp_proto_depIdxs,
		EnumInfos:         file_slg_proto_v1_1_0_combat_pvp_proto_enumTypes,
		MessageInfos:      file_slg_proto_v1_1_0_combat_pvp_proto_msgTypes,
	}.Build()
	File_slg_proto_v1_1_0_combat_pvp_proto = out.File
	file_slg_proto_v1_1_0_combat_pvp_proto_goTypes = nil
	file_slg_proto_v1_1_0_combat_pvp_proto_depIdxs = nil
}
